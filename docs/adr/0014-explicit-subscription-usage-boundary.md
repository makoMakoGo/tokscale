...
Credential ownership and persistence follow ADR 0023. In particular, Tokscale
does not copy Codex OAuth credentials or Cursor browser sessions into its own
credential stores.
