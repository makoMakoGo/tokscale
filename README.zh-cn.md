...
- **交互式 TUI 模式** - 由 Ratatui 驱动的精美终端 UI（默认模式）
  ...
  - 实时筛选和排序
  - 零闪烁渲染
- **多平台支持** - 跟踪 OpenCode、Claude Code、Codex CLI、Copilot CLI、Cursor IDE、Gemini CLI、Amp、Codebuff、Command Code、Droid、OpenClaw、Hermes Agent、Pi、OMP、Kimi、Qwen CLI、Roo Code、Kilo、Mux、Kilo CLI、Goose、Antigravity、Zed、Kiro 和 Trae 的使用情况
...
- **年份筛选**：在年份之间导航
- **来源筛选**：按平台筛选（OpenCode、Claude、Codex、Copilot、Cursor、Gemini、Amp、Codebuff、Command Code、Droid、OpenClaw、Hermes Agent、Pi、OMP、Kimi、Qwen、Roo Code、Kilo、Mux、Kilo CLI、Goose、Antigravity、Zed、Kiro、Trae）
