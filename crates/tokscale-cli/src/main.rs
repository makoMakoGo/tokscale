...
fn parse_client_id_arg(raw: &str) -> Result<ClientId, String> {
...
fn parse_default_client_filters(defaults: &[String]) -> Result<Vec<ClientId>> {
...
fn parse_client_id_set(clients: &[String]) -> std::collections::HashSet<ClientId> {
    clients
        .iter()
