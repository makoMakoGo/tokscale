...
{"type":"assistant","provider":"anthropic","timestamp":"2026-02-18T10:00:00.100Z","requestId":"req_001","message":{"id":"msg_001","usage":{"input_tokens":120,"output_tokens":15}}}"#;
    ...
    fn test_workspace_metadata_from_explicit_project_path() {
        let content = r#"{"type":"assistant","timestamp":"2024-12-01T10:00:00.000Z","projectPath":"/home/travis/tokenx-recovery","message":{"model":"claude-sonnet-4.6","usage":{"input_tokens":100,"output_tokens":50}}}"#;
        let (_dir, path) =
            create_project_file(content, "-home-travis-tokenx-recovery", "session.jsonl");
        ...
        assert_eq!(
            ...
            Some("/home/travis/tokenx-recovery")
        );
        assert_eq!(
            messages[0].workspace_label.as_deref(),
            Some("tokenx-recovery")
        );
    }

    #[test]
    fn test_workspace_metadata_prefers_entry_cwd_over_claude_project_path() {
        let content = r#"{"type":"assistant","timestamp":"2024-12-01T10:00:00.000Z","cwd":"/home/travis/01-workspace/tokenx","message":{"model":"claude-sonnet-4.6","usage":{"input_tokens":100,"output_tokens":50}}}"#;
        let (_dir, path) =
            create_project_file(content, "-home-travis-01-workspace-tokenx", "session.jsonl");
        ...
        assert_eq!(
            ...
            Some("/home/travis/01-workspace/tokenx".into())
        );
...
{"type":"assistant","timestamp":"2024-12-01T10:00:01.000Z","requestId":"req_late_cwd","cwd":"/home/travis/01-workspace/tokenx","message":{"id":"msg_late_cwd","model":"claude-sonnet-4.6","usage":{"input_tokens":120,"output_tokens":70}}}"#;
        let (_dir, path) =
            create_project_file(content, "-home-travis-01-workspace-tokenx", "session.jsonl");
    ...
    fn test_workspace_metadata_resolves_project_from_cwd_ancestor() {
        let content = r#"{"type":"assistant","timestamp":"2024-12-01T10:00:00.000Z","cwd":"/home/travis/01-workspace/tokenx/crates/tokenx-engine","message":{"model":"claude-sonnet-4.6","usage":{"input_tokens":100,"output_tokens":50}}}"#;
        let (_dir, path) =
            create_project_file(content, "-home-travis-01-workspace-tokenx", "session.jsonl");
